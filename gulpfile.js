...
// Функция для копирования базы данных из исходной папки в выходную папку
function db() {
    return src(path.src.db, { base: srcPath + "assets/db/" })
